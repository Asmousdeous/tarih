  ...
  const structures = [
    {
      name: "Çeşme 1",
      type: "Çeşme",
      description: "18. yüzyıldan kalma tarihi çeşme",
    ...
    },
    {
      name: "Cami 1",
      type: "İbadet Yeri",
      description: "18. yüzyıldan kalma tarihi cami",
    ...
    },
    {
      name: "Han 1",
      type: "Han",
      description: "18. yüzyıldan kalma tarihi han",
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-2 text-foreground">18. Yüzyıl</h1>
